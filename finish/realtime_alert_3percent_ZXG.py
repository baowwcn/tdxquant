...
def get_valid_stock_codes(sectors):
    ...
    for sector in sectors:
        try:
            # 获取板块股票列表，block_type=1 表示自定义板块
            sector_codes = tq.get_stock_list_in_sector(sector, block_type=1)
...
if __name__ == "__main__":
    ...
    try:
        ...
        tq.initialize(str(Path(__file__).resolve().parents[1] / "tqcenter.py"))
